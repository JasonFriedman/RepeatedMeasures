...
params.name = {'percentCoherent','percentAccurate','speed','direction','numFrames','aperture'};
params.type = {'number','number','number','number','number','number'};
...
params.required = [0 0 1 1 1 0];
params.default = {[],[],0,0,0,5};
