...
params.description = {'Image number to use (from those defined in setup)',...
    ...
    'color in the image that signifies the target',...
    'color in the image that signifies the start point, for use with timing feedback',...
    ...
    'Whether to show background during the feedback presentation. Either an image number, or empty',...
