...
elseif nummarkers<=8
    ...
    handleError(ts,calllib(ts.libstring, 'GetSynchronousRecord',  hex2dec('ffff'), resultPointer, 64*8));
elseif nummarkers<=12
    ...
    handleError(ts,calllib(ts.libstring, 'GetSynchronousRecord',  hex2dec('ffff'), resultPointer, 64*12));
elseif nummarkers<=16
    ...
    handleError(ts,calllib(ts.libstring, 'GetSynchronousRecord',  hex2dec('ffff'), resultPointer, 64*16));
else
