...
params.description = {'Location of the server (e.g. ''localhost'' or an IP address) ',...
    ...
    'it will only be shown when in state 1. If showPosition=3, then the fields below will be used to determine the position. If showPosition=4, it is the same as 3, but the position is only shown until the trial starts']',...
