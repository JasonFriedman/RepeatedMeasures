...
% inputParams.numchannels = numbers of channels to sample
...
params.required = 1;
params.default = {[]};
params.classdescription = 'This client connects to a DAQ server to sample one or more channels (e.g. for a button box).';
