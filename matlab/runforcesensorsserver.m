...
function runforcesensorsserver(parameters,numsensors,firstsensor)
...
% for range, 4 = +- 1V, 0 = +- 5V
system(['matlab -nojvm -r "d = forcesensorsserver(3016,6000,[' num2str(firstsensor) ' ' num2str(firstsensor+numsensors-1) '],0,' parameters ',1);listen(d)" &']);
